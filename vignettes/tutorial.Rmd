...
devtools::install_github("kwb-r/kwbGompitz@dev", auth_token = auth_token)
```
...
prediction <- kwbGompitz::runGompitzPrediction(
  ...
  range.years = c(2020, 2050)
)

# Rename column "PredictionYear" on the fly and call plotPrediction
# (unfortunately the functions to not fit well together...)
kwbGompitz:::plotPrediction(kwb.utils::renameColumns(prediction, list(
